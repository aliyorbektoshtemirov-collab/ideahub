...
function timeAgo(ts) {
  ...
  if (d < 2592000) return `${Math.floor(d / 604800)} hafta`;
...
module.exports = { uid, now, hashPass, makeToken, verifyToken, getAuth, timeAgo, readBody, parseMultipart, json, randColor };
